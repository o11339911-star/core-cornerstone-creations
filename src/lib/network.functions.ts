 ...
 *
 * الجداول والدوال المطلوبة موجودة في `supabase/migrations-pending`. قبل تطبيقها
 * تُرجع هذه الدوال `available: false` لتعرض الواجهة حالة منتج طبيعية بلا رسائل تقنية.
 */
