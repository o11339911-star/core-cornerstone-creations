...
export const en: Translations = {
  ...
  auth: {
    ...
    resetPreparing: "Verifying your recovery link...",
    resetReady: "Link verified. Choose your new password.",
    resetLinkExpired: "This recovery link has expired or was already used. Request a new one.",
    resetLinkInvalid: "This recovery link is invalid. Open the latest email or request a new link.",
    resetUpdateFailed: "Could not update the password. Request a new recovery link and try again.",
    requestNewResetLink: "Request a new link",
    updatePassword: "Update password",
    passwordUpdated: "Your password has been updated.",
    passwordMismatch: "Passwords do not match.",
    passwordTooShort: "Password must be at least 8 characters.",
    invalidCredentials: "Invalid credentials. Check your email or national ID and password.",
    ...
    fullName: "Full name",
    fullNameInvalid: "Name must be between 2 and 160 characters.",
    ...
    verifiedBody: "Taking you to identity and entity registration.",
    verifyFailedTitle: "Could not confirm the email",
    verifyExpiredBody: "The confirmation link expired or was already used. Request a new one.",
    verifyInvalidBody: "The confirmation link is not valid. Request a new one.",
    continueNow: "Continue now",
    resend: "Resend confirmation email",
    resendSent: "A new confirmation link was sent if the account still needs one.",
    resendWait: "You can resend in {seconds} seconds",
  ...
  projects: {
    listTitle: "Projects",
    listSubtitle: "Latest projects in the active account.",
    listSearchPlaceholder: "Filter by name or project number…",
    listEmpty: "No projects in this account yet.",
    listEmptyFiltered: "No project matches your search.",
    listFailed: "Could not load projects.",
    listRetry: "Retry",
    listPrev: "Previous",
    listNext: "Next",
    listPageOf: "Page {page} of {pages}",
    listNoReference: "No project number",
    ...
    propertyDeedNumber: "Deed no.",
    propertyNoReference: "No reference number",
    propertySearchPlaceholder: "Search by name, number or deed number…",
  ...
  properties: {
    ...
    owners: {
      ...
      updateFailed: "Could not update the owner.",
    ...
    links: {
      ...
      denied: {
        ...
        no_property_manage: "You cannot manage this property",
        no_active_membership: "No active membership in the entity",
        no_project_access: "You cannot access this project",
        no_effective_contract: "No effective contract allows linking these entities",
        unknown: "Link failed",
      },
    },
    kinds: {
  ...
  parties: {
    ...
    endsOnHint: "Required date after today (Riyadh time), digits 0-9 only.",
    errIdentifier: "Enter a valid 10-digit identifier.",
    errEndsRequired: "End date is required.",
    errEndsInvalid: "End date is invalid.",
    errEndsFuture: "End date must be after today.",
    errStages: "Select at least one project stage.",
    errPerms: "Select at least one permission.",
    confirmTitle: "Confirm invitation",
    confirmQuestion: "Are you sure you want to send this invitation?",
    confirmParty: "Invited party",
    confirmSend: "Confirm and send",
    confirmSending: "Sending…",
    confirmBack: "Back to edit",
  ...
  stages: {
    ...
    labelEn: "Name in the English version",
    labelEnHint: "Optional, kept under more details and used in the English version.",
    moreDetails: "More details",
    timeline: "Timeline",
    timelineEvent: "Event type",
    timelineObject: "Record",
    timelineTime: "Time",
    timelineEmpty: "No recorded events for this stage yet.",
    noActions: "You have no available actions on this stage right now.",
    highlighted: "Stage requested from the notification",
  ...
  notifications: {
    ...
    previous: "Previous",
    newSection: "New notifications",
    previousSection: "Earlier notifications",
    noNew: "No new notifications",
    noPrevious: "No earlier notifications",
    from: "From",
  ...
  registration: {
    ...
    errorTitle: "Could not verify account completion",
    errorBody: "The platform stays closed until your account data is confirmed complete.",
    signOut: "Sign out",
  },
  entities: {
    types: {
