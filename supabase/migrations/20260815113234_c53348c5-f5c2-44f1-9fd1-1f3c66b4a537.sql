...
begin
  ...
  if _status = 'waived' then
    ...
    values (uid, it.project_id, 'closure_item', _item_id, 'status_change',
...
begin
  ...
  insert into public.permission_audit_log(actor_user_id, target_project_id, object_type, object_id, action, old_value, new_value)
  values (uid, _project_id, 'project', _project_id, 'status_change',
...
begin
  ...
  insert into public.permission_audit_log(actor_user_id, target_project_id, object_type, object_id, action, old_value, new_value)
  values (uid, r.project_id, 'project_reopen', _request_id, 'status_change',
